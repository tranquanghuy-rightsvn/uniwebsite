!(function (e, t) {
    ...
    y = {
      ...
      on: function () {
        ...
        function o(e) {
          ...
          if (t) {
            ...
            if ((i.indexOf(e) < 0 && i.unshift(e), v(t).is(a))) r.apply(t, i);
            else
              for (var s = v(t).parents(), n = 0; n < s.length; n += 1)
                v(s[n]).is(a) && r.apply(s[n], i);
          }
        }
        function l(e) {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (t = v(e), i = 0; i < t.length; i += 1) if (t[i] === n) return !0;
          return !1;
        }
        if (e === a) return n === a;
        if (e === s) return n === s;
        ...
        (g = (function (e) {
          ...
          return (
            !h &&
              ...
              ((h = r.match(/(Version)\/([\d.]+)/)) || (h = [0, 1, "13_0_0"]),
              (v = !1)),
  ...
  var z = {
    ...
    L = {
      ...
      create: function () {
        E(this, { observer: t(t({}, P), {}, { observers: [] }) });
      },
      on: {
        init: function (e) {
          e.observer.init();
          ...
          if (!c || !(p <= u || p >= i.screen.width - u)) {
            if (
              ...
              d.is(s.formElements) && (f = !1),
                t.activeElement &&
                  v(t.activeElement).is(s.formElements) &&
                  t.activeElement !== d[0] &&
      ...
      if (!i.isTouchEvent || "touchmove" === o.type) {
        ...
        if (!this.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (C(a, { startX: d, startY: p, currentX: d, currentY: p }),
              (i.touchStartTime = T()))
            )
          );
  ...
  function I(e) {
    ...
    if (
      ...
      if (s.freeMode) {
        ...
        for (
          var P = 0, L = t.slidesSizesGrid[0], A = 0;
          A < o.length;
          A += A < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup
        ) {
          var O = A < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
          void 0 !== o[A + O]
            ? p >= o[A] && p < o[A + O] && ((P = A), (L = o[A + O] - o[A]))
            : p >= o[A] && ((P = A), (L = o[o.length - 1] - o[o.length - 2]));
        }
        var I = (p - o[P]) / L,
        ...
        updateSlides: function () {
          ...
          if (void 0 !== s) {
            ...
            for (
              ...
              if (t.slidesPerColumn > 1) {
                ...
                if ("row" === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
                  ...
                  (A =
                    (O =
                      H - (I = Math.floor(H / N)) * N + D * t.slidesPerGroup) +
                    (I * x) / $),
                    L.css({
                ...
                if ("auto" === t.slidesPerView) {
                  ...
                  if (
                    ...
                    var W = parseFloat(B.getPropertyValue("width") || 0),
                      ...
                      j = parseFloat(B.getPropertyValue("margin-right") || 0),
                      q = B.getPropertyValue("box-sizing");
                    if (q && "border-box" === q) E = W + R + j;
                    else {
                      var V = L[0],
                        _ = V.clientWidth;
                      E = W + Y + F + R + j + (V.offsetWidth - _);
                    }
                  } else {
                    ...
                    if (ee && "border-box" === ee) E = U + Q + J;
                    else {
                      var te = L[0],
                        ie = te.clientHeight;
                      E = U + K + Z + Q + J + (te.offsetHeight - ie);
                    }
                  }
                  ...
                  (E = (s - (t.slidesPerView - 1) * y) / t.slidesPerView),
                    t.roundLengths && (E = Math.floor(E)),
                    d[P] &&
                      (this.isHorizontal()
            ...
            if (
              ...
              t.slidesPerColumn > 1 &&
                ((this.virtualSize = (E + t.spaceBetween) * x),
                (this.virtualSize =
            ...
            if (!t.centeredSlides) {
              ...
              (h = k),
                Math.floor(this.virtualSize - s) - Math.floor(h[h.length - 1]) >
      ...
      loop: {
        loopCreate: function () {
          ...
          for (var h = 0; h < p.length; h += 1)
            s.append(v(p[h].cloneNode(!0)).addClass(i.slideDuplicateClass));
          for (var c = d.length - 1; c >= 0; c -= 1)
            s.prepend(v(d[c].cloneNode(!0)).addClass(i.slideDuplicateClass));
        },
        loopFix: function () {
          ...
          if (!o.touch && o.pointerEvents)
            ...
            if (o.touch) {
              ...
              s.addEventListener(i.start, this.onTouchStart, d),
                ...
                B || (e.addEventListener("touchstart", G), (B = !0));
            }
  ...
  var R = {
      update: function (e) {
        ...
        (m = t.rtlTranslate ? "right" : t.isHorizontal() ? "left" : "top"),
          r
            ? ((g = Math.floor(s / 2) + a + l), (w = Math.floor(s / 2) + a + o))
            : ((g = s + (a - 1) + l), (w = a + o));
    ...
    q = {
      ...
      enable: function () {
        ...
        this.keyboard.enabled ||
          (v(e).on("keydown", this.keyboard.handle),
          (this.keyboard.enabled = !0));
      },
      disable: function () {
        var e = r();
        this.keyboard.enabled &&
          (v(e).off("keydown", this.keyboard.handle),
      ...
      handle: function (e) {
        ...
        if (
          ("container" !== i.params.mousewheel.eventsTarget &&
            (a = v(i.params.mousewheel.eventsTarget)),
        ...
        if ((s.invert && (r = -r), i.params.freeMode)) {
          var l = { time: T(), delta: Math.abs(r), direction: Math.sign(r) },
          ...
          S.length >= 2 && S.shift();
          var x = S.length ? S[S.length - 1] : void 0;
          if (
            (S.push(y),
            x
      ...
      enable: function () {
        ...
        return (
          "container" !== this.params.mousewheel.eventsTarget &&
            (t = v(this.params.mousewheel.eventsTarget)),
      ...
      init: function () {
        if (this.params.scrollbar.el) {
          ...
          0 === a.length &&
            ...
            s.append(a)),
            C(e, { $el: s, el: s[0], $dragEl: a, dragEl: a[0] }),
    ...
    J = {
      ...
      onGestureStart: function (e) {
        ...
        ((a.$slideEl = v(e.target).closest("." + this.params.slideClass)),
        0 === a.$slideEl.length &&
      ...
      onTouchMove: function (e) {
        ...
        if (
          ...
          s.isMoved ||
            ...
            (s.startX = S(i.$imageWrapEl[0], "x") || 0),
            (s.startY = S(i.$imageWrapEl[0], "y") || 0),
      ...
      init: function () {
        ...
        if (
          ...
          this.params.hashNavigation.watchState &&
            v(t).on("hashchange", this.hashNavigation.onHashCange);
        }
      },
      destroy: function () {
        var e = o();
        this.params.hashNavigation.watchState &&
          v(e).off("hashchange", this.hashNavigation.onHashCange);
      },
    },
    re = {
      run: function () {
        ...
        d.shadow &&
          (p
            ...
            : 0 === (e = t.find(".swiper-cube-shadow")).length &&
              ((e = v('<div class="swiper-cube-shadow"></div>')), t.append(e)));
    ...
    pe = {
      ...
      onThumbClick: function () {
        ...
        if (e) {
          ...
          if (
            !(
              (i && v(i).hasClass(this.params.thumbs.slideThumbActiveClass)) ||
              null == t
            )
          ) {
            var s;
    ...
    he = [
      ...
      },
      {
        ...
        create: function () {
          E(this, { pagination: t({ dynamicBulletIndex: 0 }, K) });
        },
        on: {
          init: function (e) {
          ...
          click: function (e, t) {
            e.params.pagination.el &&
              ...
              !v(t.target).hasClass(e.params.pagination.bulletClass) &&
      ...
      },
      {
        ...
        create: function () {
          E(this, { lazy: t({ initialImageLoaded: !1 }, ee) });
        },
        on: {
          beforeInit: function (e) {
      ...
      },
      {
        ...
        create: function () {
          E(this, {
            controller: t({ control: this.params.controller.control }, te),
          });
        },
        on: {
          update: function (e) {
      ...
      },
      {
        ...
        create: function () {
          E(this, { hashNavigation: t({ initialized: !1 }, ae) });
        },
        on: {
          init: function (e) {
      ...
      },
      {
        ...
        create: function () {
          E(this, { autoplay: t(t({}, re), {}, { running: !1, paused: !1 }) });
        },
        on: {
          init: function (e) {
      ...
      },
      {
        ...
        create: function () {
          E(this, { thumbs: t({ swiper: null, initialized: !1 }, pe) });
        },
        on: {
          beforeInit: function (e) {
